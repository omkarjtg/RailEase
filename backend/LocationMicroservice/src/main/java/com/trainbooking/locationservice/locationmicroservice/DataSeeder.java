...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // Check if the locations table is already populated
        String countQuery = "SELECT COUNT(*) FROM location";
        ...
        if (count == null || count == 0) {
            ...
            System.out.println("Locations seeded into the database.");
        } else {
            System.out.println("Locations already exist in the database. Skipping seeding.");
        }
    }
}
